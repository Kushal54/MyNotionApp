...
using MyNotionApp.Models;

namespace MyNotionApp.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class BlogCategoriesController : ControllerBase
    {
        private readonly MyNotionContext _context;

        public BlogCategoriesController(MyNotionContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<BlogCategory>> PostBlogCategory(BlogCategory blogCategory)
        {
            ...
            return CreatedAtAction("GetBlogCategory", new { id = blogCategory.BlogCategoryId }, blogCategory);
        }
